...
저널은 세션 128개, 작업 512개를 **상한이 아니라 보관량**으로 쓴다. 한도에 닿으면 끝난 작업 기록 중 가장 오래된 것부터 지우고 새 작업을 받는다. 세션은 마지막으로 사용한 시각이 가장 오래된 것부터 지운다. 만들어진 순서가 아니라 쓰인 순서를 기준으로 삼는 이유는, 며칠 전에 연 세션이 지금 진행 중인 대화일 수 있기 때문이다.
